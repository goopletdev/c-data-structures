...
void gdOmapTest_get_shouldRetreiveValue(void) {
    ...
    TEST_ASSERT_NULL(gd_omap_get(map, 0));
    TEST_ASSERT_NULL(gd_omap_get(map, 4));
    TEST_ASSERT_EQUAL_PTR(string1, gd_omap_get(map, 1));
    TEST_ASSERT_EQUAL_PTR(string2, gd_omap_get(map, 2));
    TEST_ASSERT_EQUAL_PTR(string3, gd_omap_get(map, 3));
